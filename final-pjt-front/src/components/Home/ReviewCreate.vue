...
<body class="back">
  ...
  <form id="waterform" @submit.prevent="createreview(information, $route.params.category, $route.params.id)">
  ...
  <div class="formgroup" id="message-form">
    ...
    <input type="submit" value="제출"/>
		...
		<input class="center-block" type="button" value="취소" @click="backToDetail()"/>
  </div>
</body>
</template>
    ...
    createreview: function (information, category, id) {
      ...
      .catch((err) => {
		...
		backToDetail: function () {
			...
			this.$router.push({ name: 'ActorDetail', params: { id: this.$route.params.id }})
			}
		}
  }
}
